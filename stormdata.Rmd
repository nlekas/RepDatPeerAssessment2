...
t10popharm <- pophealth[1:10, ]
names(t10popharm) <- c("EVTYPE", "Population_Harm")
```

*STEP 7:* Figuring out ppopulation harm
...
t10econsequences <- econsequences[1:17, ]
names(t10econsequences) <- c("EVTYPE", "Economic_Consequences")
```
